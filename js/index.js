...
const VIDEO_OVERLAY_CONFIG = [
  {
    "title": "Live Preview",
    "subtitle": "See your HTML and CSS code changes instantly, without page reloads! Use powerful UI tools like the color editor to tweak background and text colors, adjust font sizes and border-radius with number dials, or explore page layouts with live code hints. <a href='https://docs.phcode.dev/docs/Features/Live%20Preview/live-preview' target='blank'>Read more...</a>",
