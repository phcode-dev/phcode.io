...
const API_URLS = {
    ...
    alerts: 'https://updates.phcode.io/siteNotifications/en.json'
};
...
const VIDEO_OVERLAY_CONFIG = [
    ...
    },
    {
        ...
        subtitle: 'Write HTML, CSS, and JavaScript faster with on-the-fly code completion and catch errors before they become problems. We\'re always adding better smarts to our code intelligence, making Phoenix Code sharper with every release. It\'s web development with everything you need, right out of the box- no extensions needed.',
