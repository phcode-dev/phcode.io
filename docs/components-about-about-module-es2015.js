...
/* harmony import */ var _main_sections_landing_footer_footer_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../main/sections/landing/footer/footer.component */ "./src/app/components/main/sections/landing/footer/footer.component.ts");
...
AboutComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AboutComponent, selectors: [["px-about"]], decls: 40, vars: 0, consts: [[1, "body"], [1, "p-5", "container"], [1, "main-heading"], [1, "row", "p-4"], [1, "col-md-6"], [1, "row"], [1, "col-md-2"], ["src", "assets/images/transparency_icon.svg", "alt", ""], [1, "col-md-10", "text-left", "mb-4"], [1, "sub-heading"], ["src", "assets/images/open_code_icon.svg", "alt", ""], [1, "d-flex-center", "row", "team"], [1, "col-md-12", "d-flex-center", "flex-column"], ["src", "assets/images/team.png", "alt", ""], [1, "main-heading", "my-2"]], template: function AboutComponent_Template(rf, ctx) { if (rf & 1) {
